...
pub async fn run_serve(args: ServeArgs) -> Result<()> {
    ...
    let reload_task = crate::cli::serve_tasks::spawn_reload_poller(
        &reload_controller,
        &writer,
        &neoth_home,
    );
    ...
    let obsidian_preload_task = crate::cli::serve_tasks::spawn_obsidian_preload(
        &config,
        &neoth_home,
        writer.clone(),
    );
    ...
    let updater_skill_task =
        crate::cli::serve_tasks::spawn_updater_skill_cron(
            updater_cron_cfg.clone(),
            &neoth_home,
            writer.clone(),
        );
    ...
    let g02_surfacing_cron_handle =
        crate::cli::serve_tasks::spawn_g02_surfacing_cron(&neoth_home);
    ...
    #[cfg(feature = "cluster")]
    let cluster_foreign_indexer_task =
        crate::cli::serve_tasks::spawn_foreign_indexer(&neoth_home);
    ...
    let installer_audit_task = crate::cli::serve_tasks::spawn_installer_audit_ingester(
        &neoth_home,
        writer.clone(),
    );
    ...
    // secret material.
    // GOLD-ARCH-01: body relocated to serve_tasks (same handle, same site).
    let credentials_import_task = crate::cli::serve_tasks::spawn_credentials_import_ingester(
        &neoth_home,
        writer.clone(),
    );
    ...
    // GOLD-ARCH-01: body relocated to serve_tasks (same handle, same site).
    let detect_complete_task = crate::cli::serve_tasks::spawn_detect_complete_ingester(
        &neoth_home,
        writer.clone(),
    );
    ...
    // GOLD-ARCH-01: construction relocated to serve_tasks (same handle, same site).
    let self_dev_outbox_task =
        crate::cli::serve_tasks::spawn_self_dev_outbox(&neoth_home, &writer);
