...
const OPERATION_INVENTORY: &[OperationParity] = &[
    ...
    OperationParity {
        ...
        receipt: Evidence::Untyped("fn fetch_embedding_models_status_for", "validate_neothd_probe_exit"),
        readback: Evidence::Typed("fn fetch_embedding_models_status_for", "parse_embedding_models_status"),
        state: OperationState::Partial("the Resources refresh has a typed status DTO but no explicit status control or retained receipt"),
    },
    OperationParity {
        ...
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn register_embedding_model_callbacks", "snapshot.selected_model != expected_model"),
        state: OperationState::Verified,
    },
    OperationParity {
        ...
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_embedding_model_action", "embedding_snapshot_is_fresh_ready_for"),
        state: OperationState::Verified,
    },
    OperationParity {
        ...
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_embedding_model_action", "snapshot.selected_model != expected_model"),
        state: OperationState::Verified,
    },
    OperationParity {
    ...
    OperationParity {
        id: "buddy.embedding.status", capability: "buddy", cli_path: "buddy embedding status", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Refresh",
        ui_callback: None, rust_handler: Some("fn fetch_embedding_models_status_for"),
        dispatch_token: Some("surface.cli_prefix().to_vec()"),
        receipt: Evidence::Untyped("fn fetch_embedding_models_status_for", "validate_neothd_probe_exit"),
        readback: Evidence::Typed("fn fetch_embedding_models_status_for", "parse_embedding_models_status"),
        state: OperationState::Partial("the Buddy refresh projects a typed selected-model status DTO but has no separate retained status receipt"),
    },
    OperationParity {
        id: "buddy.embedding.select", capability: "buddy", cli_path: "buddy embedding select", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Selected model",
        ui_callback: Some("bc-embedding-model-changed"), rust_handler: Some("fn start_buddy_embedding_model_selection"),
        dispatch_token: Some("EmbeddingCommandSurface::Buddy, \"select\""),
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_buddy_embedding_model_selection", "snapshot.selected_model != expected_model"), state: OperationState::Verified,
    },
    OperationParity {
        id: "buddy.embedding.probe", capability: "buddy", cli_path: "buddy embedding probe", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Verify",
        ui_callback: Some("bc-embedding-probe"), rust_handler: Some("fn register_buddy_embedding_callbacks"),
        dispatch_token: Some("EmbeddingCommandSurface::Buddy, \"probe\""),
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_embedding_model_action", "embedding_snapshot_is_fresh_ready_for"), state: OperationState::Verified,
    },
    OperationParity {
        id: "buddy.embedding.pull", capability: "buddy", cli_path: "buddy embedding pull", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Pull",
        ui_callback: Some("bc-embedding-pull"), rust_handler: Some("fn register_buddy_embedding_callbacks"),
        dispatch_token: Some("EmbeddingCommandSurface::Buddy, \"pull\""),
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_embedding_model_action", "snapshot.selected_model != expected_model"), state: OperationState::Verified,
    },
    OperationParity {
        id: "buddy.embedding.repair", capability: "buddy", cli_path: "buddy embedding repair", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Repair",
        ui_callback: Some("bc-embedding-repair"), rust_handler: Some("fn register_buddy_embedding_callbacks"),
        dispatch_token: Some("EmbeddingCommandSurface::Buddy, \"repair\""),
        receipt: Evidence::Typed("fn run_embedding_model_command", "parse_embedding_models_status"),
        readback: Evidence::Typed("fn start_embedding_model_action", "snapshot.selected_model != expected_model"), state: OperationState::Verified,
    },
    OperationParity {
        id: "buddy.embedding.prune", capability: "buddy", cli_path: "buddy embedding prune", gui_nav: "buddyconfig", gui_surface: "Buddy Config > local embedding model > Prune",
        ui_callback: Some("bc-embedding-prune"), rust_handler: Some("fn register_buddy_embedding_callbacks"),
