...
//! the caller can decide whether to deliver or discard it. The cron runner
//! scores before queueing, performs one bounded regeneration through the same
//! authorized provider, and withholds delivery if the retry still fails.
//!
//! ## What is scored
//!
