...
pub fn pending_payload(delta: &ProfileDelta, now_unix: u64) -> Vec<u8> {
    ...
    serde_json::to_vec(&value)
        .expect("PROFILE_DELTA_PENDING payload is a serde_json::Value")
}
...
pub fn approved_payload(extraction_id: &str, claim_count: usize, now_unix: u64) -> Vec<u8> {
    ...
    serde_json::to_vec(&value)
        .expect("PROFILE_DELTA_APPROVED payload is a serde_json::Value")
}
...
pub fn declined_payload(
    ...
    serde_json::to_vec(&value)
        .expect("PROFILE_DELTA_DECLINED payload is a serde_json::Value")
}
