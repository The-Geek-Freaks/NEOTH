...
fn parse_source_weight(json: &str) -> serde_json::Result<std::collections::BTreeMap<String, u32>> {
    serde_json::from_str(json)
}

fn source_weight_json(map: &std::collections::BTreeMap<String, u32>) -> serde_json::Result<String> {
