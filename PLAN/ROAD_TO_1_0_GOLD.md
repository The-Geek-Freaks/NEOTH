...
|------------|-------------|------|------|
| WS-A Security hardening | 35 | 5 | 30 |
...
_WS-A remaining (5): SEC-16 + SEC-18 (Cargo feature-gates — dedicated dual-build `--no-default-features` pass) · SEC-30 (sudomode WAL events — pairs with GOLD-FEAT-01) · SEC-31 (GUI error-bubble colour — display-gated Slint) · SEC-32 (daily LLM-call hard cap — needs a rolling-24h call counter)._
