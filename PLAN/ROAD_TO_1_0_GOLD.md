...
|------------|-------------|------|------|
| WS-A Security hardening | 35 | 8 | 27 |
...
_WS-A remaining (8): SEC-16 + SEC-18 (Cargo feature-gates — dedicated dual-build pass) · SEC-23 (OBS pw via config-file + gh repo/state allowlist) · SEC-29 + SEC-33 (Windows home-isolation DACL check) · SEC-30 (sudomode WAL events — pairs with GOLD-FEAT-01) · SEC-31 (GUI error-bubble colour — display-gated) · SEC-32 (daily LLM-call hard cap — needs rolling-24h counter)._
