...
|------------|-------------|------|------|
| WS-A Security hardening | 35 | 27 | 8 |
...
_Progress log: 2026-06-06 — GOLD-SEC-01/17 (relay auth + cap) · GOLD-SEC-02/27 (backup zip-slip + creds opt-out) · GOLD-SEC-03 (skills installer id traversal) · GOLD-SEC-04/28/34 (LIKE-escape + GDPR idx_profile cascade)._
