...
b6_research: >
  ...
  with ODY-01..05).
next: WAVE 4 — B15 eval wave-2 (ai-engineering-from-scratch, ECC, Anthropic-Cybersecurity-Skills, Scrapling) ∥ adhd-steal #1 (15-frame isolation library → brainstorming skill Phase 2.5, pure YAML) ∥ FEAT-10b (BlueBubbles iMessage + Google Chat Pub/Sub + signal rate-limit port) ∥ ODY-31 (scope-gated API tokens, security-reviewer MANDATORY) — then B7/B8 GUI wave (GUI-01..08, LOOP-03, ODY-01..05/12/14, AOS-01..06, OH-12; needs cargo check -p neothd-gui) → B10 rest (HANDY-02 VAD [Cargo.toml owner], ADOPT-25 whisper-rs) → B11 (JV-SEC-REST, PAPERLESS-01) → B13 RMAS → B14 (FEAT-03b/05/06, OH-01) → B16 Jarvis sync → B17 release. STATE 2026-07-03 late: B3/B4/B5/B6 COMPLETE + error-hunt#1 + wave-3 (HANDY-04, CLUSTER-01, alias map, web_extract skill, IRC=pre-existing verify-hit); 52 open; HEAD 1d198111; eval reports: research/b15_eval_wave1_2026-07-03.md + b6_task_sovereign_research.
