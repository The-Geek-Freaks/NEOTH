...
- [~] **CH-11** Callosum profile consultation in dissent resolution (P2 Day 53-55) — *Builds on shipped P-06 confidence gate + P-07 relevance bonus + CH-09 Block-B injection primitives.* Multi-file wire-up into `council/callosum.rs::resolve_with_profile` (~50 LOC + 4 tests). Bounded follow-up session.
