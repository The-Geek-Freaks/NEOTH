...
**V03-09 Phase 2a — self-update asset locator (2026-05-21):**
...
- V03-09 phase 2b (download+verify+extract+replace) — asset locator + bundle resolver shipped 2026-05-21; download path waits on `freedom.yaml::auto_update.{auto_apply,channel}` knobs.
