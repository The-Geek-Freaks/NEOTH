...
- [~] **K-Label-Spoof** Structural separator in `profile/extract.rs::render_user_prompt` — same bucket as K-Validate-ZeroEv: real bug, deferred per the same privacy-deprioritisation cue. Tracked as `[~]` for the same future sprint.
