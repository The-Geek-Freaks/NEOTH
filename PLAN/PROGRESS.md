...
- Discord WSS reply-back wiring — loop + heartbeat-tick + dial + IDENTIFY/RESUME + dispatch shipped 2026-05-21; outbound REST `chat.create-message` from inside the loop pending (needs `DiscordChannel` handle in scope).
