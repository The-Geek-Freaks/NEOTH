...
- [~] **E-10** `neoth-plugin-sdk` crate on crates.io (Day-15) — *Same as V10-03.* Publish infra (Cargo.toml metadata + README + license + crates.io account). Operator-side release step.
...
- [~] **V10-03** Plugin SDK published to crates.io as `neoth-plugin-sdk = "0.1"` — *Same as E-10.* Publish infra (Cargo.toml + README + crates.io publish step), operator-side release work.
