...
- [~] **V10-04** WASM plugin host (Day-23 wasmtime) functional with ≥2 example plugins — GA blocker. wasmtime + 2 example plugins is multi-day. E-21 design decision pending (default-active vs default-inactive).
